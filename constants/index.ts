...
export const NAV_LINKS = [
  ...
  export const NAV_LINKS2 = [
    ...
    { href: '/', key: 'nft', label: 'NFTs Collection |' },
    { href: '/', key: 'marketing_graphics', label: 'Marketing Graphics |' },
    { href: '/', key: 'branding', label: 'Branding and more!' },
  ];
